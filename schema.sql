-- ================================================================
-- SFC ALMOXARIFADO — SCHEMA LIMPO E DEFINITIVO
-- PASSO 1: Execute os DROPs para limpar tudo
-- PASSO 2: Execute o resto para recriar
-- ================================================================
...
-- ================================================================
-- TABELA: usuarios
-- nick      = apelido/login único
-- senha_hash = bcrypt
-- perfil    = admin | almoxarife | usuario
-- ativo     = true/false
-- ================================================================
CREATE TABLE usuarios (
    ...
    perfil     TEXT NOT NULL DEFAULT 'usuario'
                 CHECK (perfil IN ('admin','almoxarife','usuario')),
    nome       TEXT,
    email      TEXT,
...
CREATE TABLE documentos (
    ...
    status_envio    TEXT NOT NULL DEFAULT 'pendente'
                      CHECK (status_envio IN ('pendente','enviado','nao_requer')),
...
CREATE TABLE movimentacoes (
    ...
    status                TEXT NOT NULL DEFAULT 'pendente'
                            CHECK (status IN ('pendente','aprovado','rejeitado','concluido','cancelado')),
...
CREATE OR REPLACE FUNCTION fn_codigo_interno()
...
CREATE TRIGGER trg_codigo BEFORE INSERT ON produtos
FOR EACH ROW EXECUTE FUNCTION fn_codigo_interno();

-- ── TRIGGER: atualiza estoque ────────────────────────────────────
CREATE OR REPLACE FUNCTION fn_estoque()
RETURNS TRIGGER LANGUAGE plpgsql AS $$
BEGIN
...
CREATE TRIGGER trg_estoque AFTER INSERT OR UPDATE ON movimentacoes
FOR EACH ROW EXECUTE FUNCTION fn_estoque();
...
DO $$ DECLARE t TEXT;
BEGIN
  FOREACH t IN ARRAY ARRAY['usuarios','categorias','setores','produtos','documentos','movimentacoes','configuracoes']
  LOOP
...
INSERT INTO categorias (nome) VALUES
  ('Limpeza'),('Escritório'),('Informática'),('Ferramentas'),
  ('EPI'),('Elétrico'),('Alimentício'),('Manutenção'),('Outros')
ON CONFLICT (nome) DO NOTHING;

INSERT INTO setores (nome) VALUES
  ('Administrativo'),('Financeiro'),('RH'),('TI'),('Manutenção'),
  ('Operações'),('Logística'),('Marketing'),('Comercial'),('Diretoria')
ON CONFLICT (nome) DO NOTHING;
