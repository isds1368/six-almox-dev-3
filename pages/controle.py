...
Mesma arquitetura em camadas de antes, só que tudo num arquivo:
    1) MODELOS — dataclasses e constantes de domínio
    2) REPOSITORY — acesso a dados (hoje em session_state; TODOs para Supabase)
    3) SERVICE — regras de negócio
    4) UI — telas Streamlit (mapa, detalhe, cadastro, dashboard)
